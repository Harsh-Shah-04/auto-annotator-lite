...
st.title("🚦 Environment Smoke Test")

# Show versions to confirm correct wheels are installed
ok = True
try:
    import torch, torchvision, PIL, cv2, numpy
...
if ok:
    st.success("All core deps imported successfully! You can now add your model + full app code.")
